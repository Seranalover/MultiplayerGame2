...
void ACharacterDisplay::ConfigureWithCharacterDefinition(const UPA_CharacterDefination* CharacterDefination)
{
	...
	MeshComponent->SetAnimClass(CharacterDefination->LoadDisplayAnimBP());
}
