...
void UStatsGauge::NativePreConstruct()
{
	...
	Icon->SetBrushFromTexture(IconTexture); //设置纹理笔刷
}
...
void UStatsGauge::NativeConstruct()
{
	...
	{
		bool bFound;
		float AttributeValue = OwnerASC->GetGameplayAttributeValue(GameplayAttribute, bFound);
		SetValue(AttributeValue);
		OwnerASC->GetGameplayAttributeValueChangeDelegate(GameplayAttribute).AddUObject(this, &UStatsGauge::AttributeChanged);
	}
}
